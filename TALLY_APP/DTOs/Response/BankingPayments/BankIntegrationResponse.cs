...
namespace TALLY_APP.DTOs.Response.BankingPayments
{
    ...
    /**
     * Response DTO: PaginatedBankIntegrationResponse
     *
     * Purpose:
     * API response model for paginated bank integration list
     */
    public class PaginatedBankIntegrationResponse
    {
        public List<BankIntegrationResponse> Data { get; set; }
