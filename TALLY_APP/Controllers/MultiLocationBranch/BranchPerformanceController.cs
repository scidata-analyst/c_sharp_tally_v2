...
namespace TALLY_APP.Controllers.MultiLocationBranch
{
    ...
    {
        [HttpGet("")]
        public IActionResult Index() => View("~/Views/MultiLocationBranch/performance.cshtml");
        ...
        [HttpGet("api/index")]
        public async Task<ActionResult<PaginatedBranchPerformanceResponse>> ApiIndex(
