...
namespace TALLY_APP.Controllers.PayrollManagement
{
     ...
     *
     * Description:
     * Handles all CRUD operations for Payslip module.
    ...
    public class PayslipController : ControllerBase
    {
         ...
         */
        [HttpGet("all")]
        public async Task<ActionResult<List<PayslipResponse>>> GetAll()
        {
         ...
         * @return Single Payslip object
         */
        [HttpGet("view/{id}")]
        public async Task<ActionResult<PayslipResponse>> View(long id)
        {
         ...
         */
        [HttpPost("create")]
        public async Task<ActionResult<PayslipResponse>> Create([FromBody] PayslipRequest request)
        {
         ...
         */
        [HttpPut("update/{id}")]
        public async Task<ActionResult<PayslipResponse>> Update(long id, [FromBody] PayslipRequest request)
        {
